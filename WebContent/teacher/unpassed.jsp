...
<body>
   ...
   <div class="ExamList">
   <form action="">
	<p align="center"><img src="<%=request.getContextPath()%>/images/unpassed.jpg" width="300px"></p>
     ...
     <tr>
       ...
       <td><a href="<%=request.getContextPath()%>/findexam_look.action?eid=<s:property value="#e.eid"/>">查看</td>
     </tr>
	 </s:iterator>
