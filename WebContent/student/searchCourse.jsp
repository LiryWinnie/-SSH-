   ...
   <div class="ExamList">
      <h3>搜索结果</h3>
       ...
       <tr>
           ...
           <th width="200px">老师工号</th>
           <th width="200px">操作</th>
       </tr>
       <s:iterator value="#exams" var="e">
       <tr>
           <td width="200px"><s:property value="#e.course"/></td>
           <td width="200px"><s:property value="#e.tname"/></td>
           <td width="200px"><s:property value="#e.tnumber"/></td>
           <td><a href="<%=request.getContextPath()%>/studentexam_add.action?eid=<s:property value="#e.eid"/>">添加课程</td>
       </tr>
       </s:iterator>
       </table>
   </div>
