...
<body>
   ...
   <table border="1" cellspacing="0" align="center">
     ...
     <tr>
       ...
       <td><a href="<%=request.getContextPath()%>/deanfind_add.action?eid=<s:property value="#e.eid"/>">添加题目</a></td>
       <td><a href="<%=request.getContextPath()%>/deanfind_pub.action?eid=<s:property value="#e.eid"/>">发布</a></td>
       <td><a href="<%=request.getContextPath()%>/deanfind_que.action?eid=<s:property value="#e.eid"/>">查看题库</a></td>
     </tr>
     </s:iterator>
   </table>
   </div>
